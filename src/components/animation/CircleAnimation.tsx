...
const CircleBurstAnimation = () => {
  ...
  return (
    <div ref={containerRef} className="relative flex items-center justify-center w-full min-h-64 ">
      ...
      `}>
        ...
        `}>
          <div className="bg-white rounded-lg shadow-md px-6 py-3">
            <p className="text-gray-700 font-medium font-montserrat whitespace-nowrap">
              {getProgressText()}
            </p>
          </div>
        </div>
      ...
      `}>
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto font-montserrat">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-nowrap gap-2 overflow-x-auto pb-2">
              ...
              <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-xs md:text-sm whitespace-nowrap">
                Annual Report
              </span>
              <span className="px-3 py-1 bg-purple-100 text-purple-800 rounded-full text-xs md:text-sm whitespace-nowrap">
                2024
              </span>
            </div>
