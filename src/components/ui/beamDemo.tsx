...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border border-opacity-40 bg-black p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[300px]  w-[70%] items-center justify-center overflow-hidden rounded-lg bg-transparent p-2 md:shadow-xl"
      ref={containerRef}
    >
