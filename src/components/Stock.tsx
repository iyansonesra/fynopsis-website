    ...
    <div className='w-full h-full flex flex-col'>
      ...
      <div className='flex flex-[10] flex-row h-[80%] px-4 gap-4 '>
        <div className="flex-[3] flex flex-col w-[60%] h-[90%] xl:h-[85%] 2xl:h-[88%] gap-4">
          <div className="flex flex-[2] h-[40%] rounded-2xl ">
            <CustomGraph
              data={data}
              height="100%"
              width="100%"
              gradientColor="#3295C0"
        ...
        <div className="flex-[2] relative flex w-[40%] h-[90%] xl:h-[85%] 2xl:h-[88%]">
          ...
          <div className="absolute rounded-2xl bottom-2 left-0 right-0  h-8 2xl:h-12 bg-gradient-to-t from-slate-50 to-transparent pointer-events-none"></div>
