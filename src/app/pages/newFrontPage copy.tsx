...
const FrontPage: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col font-cormorant overflow-x-hidden bg-black">
            ...
            <div className="relative z-10 overflow-hidden">
                {/* Navigation bar */}
                <div className="fixed top-0 left-0 right-0 h-16 md:h-16 xl:h-20 bg-black bg-opacity-98 w-full flex items-center justify-between lg:px-12 sm:px-4 px-4 select-none font-poppins z-20">
                    <div className="flex flex-row items-center">
                        <img src={logo.src} alt="logo" className="sm:h-10 sm:w-auto w-[10%] h-auto" />
                        <h1 className="font-semibold text-lg text-white sm:text-2xl md:text-2xl font-montserrat">Fynopsis</h1>
                    </div>
                    ...
                    <div className="h-full flex items-center gap-4">
                        ...
                        <button
                            className="inline-block font-light text-md sm:text-base md:text-lg text-white font-montserrat px-6 py-1 rounded-lg text-black no-wrap"
                ...
                {/* Main content */}
                <div className="flex flex-row mt-20 w-full justify-center bg-black">
                    ...
                    <div className="inline-block max-w-[90%]  text-center px-5 sm:px-10 lg:px-20 rounded-2xl flex flex-col pt-12 ">
                        <h1 className="font-semibold gradient-text font-bold text-4xl sm:text-5xl lg:text-5xl font-montserrat">AI-powered data rooms for your team.</h1>
                        <h1 className="font-semibold font-light text-base sm:text-md lg:text-lg text-white font-montserrat font-thin font-italic mt-4">Search and organize thousands of documents in seconds, so you can focus on what matters.</h1>
                        <div className="flex flex-row items-center justify-center mt-8">
                            <input type="text" placeholder="Enter your email to get early access" className="w-[55%] border h-12 bg-black rounded-2xl px-4 text-slate-900 border-slate-400 text-xl outline-none font-montserrat" />
